...
const dummyNotices: Notice[] = [
  {
    id: 1,
    title: 'CUIF+ 2025 대회 개최 안내',
    content: `안녕하세요. CUIF+ 2025 3川지역 정책 아이디어 경진대회 개최를 안내드립니다.
...
※ 현재 데모 모드입니다. 실제 Supabase 데이터베이스 연결 후 실제 공지사항이 표시됩니다.`,
  ...
  },
  {
    id: 2,
    title: '사전 설명회 개최 안내',
    content: `CUIF+ 2025 대회 참가를 희망하는 학생들을 위한 사전 설명회를 개최합니다.
...
※ 현재 데모 모드입니다.`,
  ...
  },
  {
    id: 3,
    title: '참가 신청서 작성 가이드',
    content: `참가 신청서 작성 시 유의사항을 안내드립니다.

✅ 팀 구성: 2명 이상 7명 이하
✅ 팀장은 대학(원)생이어야 함
✅ 아이디어는 3川지역(포천, 연천, 가평) 관련이어야 함
✅ 제출 서류: 신청서, 팀원 명단, 아이디어 개요서
